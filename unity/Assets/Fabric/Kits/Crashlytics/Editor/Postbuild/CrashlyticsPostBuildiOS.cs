namespace Fabric.Internal.Crashlytics.Editor.Postbuild
{
    ...
    public class CrashlyticsPostBuildiOS : PostBuildiOS
    {
        ...
        private static readonly string[] platformFrameworks = new string[] {
            "Security.framework"
        };

        private static readonly string[] frameworks = new string[] {
            "Fabric.framework",
            "Crashlytics.framework"
        };

        private static readonly string[] platformLibs = new string[] {
            "libz.dylib",
            "libc++.dylib"
        };

        private static readonly string[] libs = new string[] {
        ...
        {
#if UNITY_5_5_OR_NEWER
            bool isOldiOSVersion = new System.Version(PlayerSettings.iOS.targetOSVersionString) < new System.Version("6.0");
#else
