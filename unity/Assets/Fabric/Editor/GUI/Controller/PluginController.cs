namespace Fabric.Internal.Editor.Controller
{
    ...
    {
        private static readonly Client client = new Client(Net.Constants.URI);

        private static readonly Update.FabricInstaller.Config defaultConfig = new FabricInstaller.Config(
        ...
        private readonly Update.FabricInstaller fabricInstaller = new FabricInstaller(LatestPluginConfig);
        ...
        private readonly Page login;
        private readonly Page orgs;

        private readonly Page validation;
        private readonly Page kitSelection;
        private readonly Page updatePage;
        private readonly Page conflictPage;
        private readonly Page manualInitialization;
