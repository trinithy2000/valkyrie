namespace Fabric.Internal.Editor.View
{
    ...
    internal class ConflictResolutionPage : Page
    {
        ...
        private readonly Func<string> toInstall;
        private readonly Func<string, HashSet<string>> toUpdate;
        private readonly KitsList availableKits;
        ...
        private static class Components
        {
            ...
            static Components()
            {
                ...
                {
                    margin = new RectOffset(18, 16, 18, 0)
                };
