namespace Fabric.Internal.Editor.View
{
    ...
    internal class LoginPage : Page
    {
        ...
        private readonly Action<string, Action<string>> onLoginButtonClick;
        private readonly Action onSignupLinkClick;
        private string status = "";

        public LoginPage(Action<string, Action<String>> onLoginButtonClick)
        {
            this.onLoginButtonClick = onLoginButtonClick;
            onSignupLinkClick = delegate ()
            {
        ...
        private static class Components
        {
            ...
            static Components()
            {
                ...
                LogoStyle = new GUIStyle
                {
                    fixedHeight = 99,
                    fixedWidth = 95,
                    margin = new RectOffset(0, 0, 40, 0)
                };
